...
public abstract class LocalPlayerMixin extends Player {
    ...
    @WrapOperation(remap = false, method = "aiStep", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/player/LocalPlayer;canStartSwimming()Z"))
    ...
    @WrapOperation(remap = false, method = "aiStep", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/player/LocalPlayer;isInFluidType(Ljava/util/function/BiPredicate;)Z"))
