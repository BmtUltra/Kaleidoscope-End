...
public class KEBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        simpleCropBlockLoot(KEBlocks.ENDER_MINT.get(), KEItem.ENDER_MINT.get(), KEItem.ENDER_MINT.get());

        vines(KEBlocks.DREAM_BERRY_HEAD.get(), KEItem.DREAM_BERRY_ITEM.get());
        vines(KEBlocks.DREAM_BERRY_PLANT.get(), KEItem.DREAM_BERRY_ITEM.get());
    }
