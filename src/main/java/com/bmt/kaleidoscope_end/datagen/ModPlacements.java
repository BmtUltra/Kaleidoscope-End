...
public class ModPlacements {
    ...
    private static List<PlacementModifier> rareOrePlacement(int chance, PlacementModifier placementModifier) {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, SUSPICIOUS_END_STONE_LARGE, holder1, rareOrePlacement(9, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(0), VerticalAnchor.aboveBottom(80))));
