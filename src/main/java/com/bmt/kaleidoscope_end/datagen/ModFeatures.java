...
public class ModFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> list2 = List.of(OreConfiguration.target(ruleTest, KEBlocks.SUSPICIOUS_END_STONE.get().defaultBlockState()));
        ...
        RandomizedIntStateProvider dreamBerryHead = new RandomizedIntStateProvider(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(KEBlocks.DREAM_BERRY_HEAD.get().defaultBlockState(), 4).add(KEBlocks.DREAM_BERRY_HEAD.get().defaultBlockState().setValue(CaveVines.BERRIES, true), 1).build()), CaveVinesBlock.AGE, UniformInt.of(23, 25));
        WeightedStateProvider dreamBerryPlant = new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(KEBlocks.DREAM_BERRY_PLANT.get().defaultBlockState(), 1).add(KEBlocks.DREAM_BERRY_PLANT.get().defaultBlockState().setValue(CaveVines.BERRIES, true), 1));
                ...
                new RandomPatchConfiguration(
                        ...
                        PlacementUtils.filtered(
                                ...
                                new SimpleBlockConfiguration(
                                        BlockStateProvider.simple(KEBlocks.ENDER_MINT.get().defaultBlockState().setValue(CropBlock.AGE, 7))
                                ),
